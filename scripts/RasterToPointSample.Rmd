...
## Rasters
```{r}
r1 = raster("../data/UTMImagesTest/dnbr/UTM51/dNBRimg_3880.tif")
```

```{r}
r2 = raster("../data/UTMImagesTest/dnbr/dNBRimg_3880.tif")
```


```{r}
r3 = raster("../data/dnbrSingleFire/dNBRimg_3880.tif")
```

## Fire perimeters 
```{r}
firesEA = st_read("../data/NESiberiaFires/NESiberiaFires2020.shp", "NESiberiaFires2020")
```
...
```{r}
plot(crop_r3)
plot(st_geometry(fire2), add=TRUE)
```
