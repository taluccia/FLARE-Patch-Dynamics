...
## Rasters
```{r}
r1 = raster("../data/UTMImagesTest/dnbr/UTM51/dNBRimg_3902.tif")
```
...
## Write  to Shapefile
```{r}
st_write(samplePt, "../outputs/RasterToPointUTM/Points3902.shp", driver="ESRI Shapefile") 
```
