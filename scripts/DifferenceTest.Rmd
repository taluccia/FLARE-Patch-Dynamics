...
theme_bw() +
ylab("") + xlab("Difference in mean patch size (ha)") + 
...
```{r}
 # Stack the differences in means vectors together
(diffestmod2 = rbind(small_large, medium_large, small_medium) )
```
...
theme_bw() +
ylab("") + xlab("Difference in patch density") + 
theme(axis.ticks.y = element_blank(),
axis.text.y = element_blank() ) + 
  theme(panel.grid.major.y = element_blank() ) + 
