...
msplot1 = cowplot::plot_grid(varInfPlot, all_mod_plots4$TPI450, all_mod_plots4$SLPPCT, all_mod_plots4$elevation, all_mod_plots4$latitude, all_mod_plots4$treecover2000,  ncol = 2) +
   ...
   draw_label("(a)", x = .02, y = .98, size = 10) +
   draw_label("(b)", x = .53, y = .98, size = 10) +
   draw_label("(c)", x = .02, y = .64, size = 10) +
   draw_label("(d)", x = .53, y = .64, size = 10) +
   draw_label("(e)", x = .02, y = .32, size = 10) +
   draw_label("(f)", x = .53, y = .32, size = 10)
